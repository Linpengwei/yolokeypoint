...
@torch.no_grad()
def run(poseweights="yolov7-w6-pose.pt", source="sleep1.mp4", device='cpu', view_img=False,
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='sleep1.mp4', help='video/0 for webcam')  # video source
